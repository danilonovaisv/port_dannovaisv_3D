...
// The https library also has other utility methods such as hasClaim, which
// verifies that a caller's token has a specific claim (optionally matching a
// specific value)
...
// these sensitive values can be controlled. defineSecret does this for you
// automatically.
// If you are using Google Developer API (googleAI) you can get an API key at
