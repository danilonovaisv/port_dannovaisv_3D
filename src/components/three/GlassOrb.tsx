...
export default function GlassOrb({ pointer, scroll }: GlassOrbProps) {
  ...
  useFrame((state) => {
    ...
    group.rotation.x = THREE.MathUtils.lerp(group.rotation.x, targetTiltX - 0.4, 0.08);
    group.rotation.y = THREE.MathUtils.lerp(group.rotation.y, idleRotationY + targetTiltY, 0.08);
